...
//LED
bool flagLED = true;  // Флаг для Вкл./Выкл. LED с пульта
byte regim_LED = 0;   // Здесь храним номер пина для LED, которы будем включать (0 - выкл. все LED, 1- GREEN, 2 - BLUE, 3- RED)

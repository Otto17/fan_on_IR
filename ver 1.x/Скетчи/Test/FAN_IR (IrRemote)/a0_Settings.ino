...
#define IR_OK         0xA25D807F    // Кнопка OK: Off (Выключить ВСЁ)
#define IR_UP         0xA25D01FE     // Кнопка вверх: ↑ Авто - Вращения Вкл.
#define IR_DOWN       0xA25D817E    // Кнопка вниз:  ↓ Авто - Вращения Выкл.
#define IR_LEFT       0xA25D8A75    // Кнопка <: « Влево
#define IR_RIGHT      0xA25DB24D    // Кнопка >: Вправо »
#define IR_1          0xA25D20DF    // Кнопка 1: 1 режим (On)
